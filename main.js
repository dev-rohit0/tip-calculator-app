...
numberOfPeople.addEventListener('change',(e)=>{
    if(e.target.value==0){
        document.getElementById('spclElement').classList.remove('hidden')
        document.getElementById('totalPeople').classList.add('focus:ring-red-700')
    }else{
        document.getElementById('totalPeople').classList.remove('focus:ring-red-700')
        
        document.getElementById('spclElement').classList.add('hidden')
